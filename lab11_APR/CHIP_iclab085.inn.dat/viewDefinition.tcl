...
create_library_set -name lib_min\
   -timing\
    ...
    ${::IMEX::libVar}/mmmc/SRAM_128_64_200M_fast_syn.lib]\
   -si\
    [list ${::IMEX::libVar}/mmmc/fast.cdb]
create_library_set -name lib_max\
   -timing\
    [list ${::IMEX::libVar}/lib/typ/umc18io3v5v_slow.lib\
    ${::IMEX::libVar}/lib/typ/SRAM_128_64_200M_slow_syn.lib\
    ${::IMEX::libVar}/lib/typ/slow.lib]\
   -si\
